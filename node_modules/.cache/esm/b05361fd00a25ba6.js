let dotenv,express,Client;_00a‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_00a‍.w("express",[["default",["express"],function(v){express=v}]]);_00a‍.w("@notionhq/client",[["Client",["Client"],function(v){Client=v}]]);
...
app.get("/", function (request, response) {
  response.sendFile(_00a‍.t("__dirname") + "/public/index.html")
})
...
const listener = app.listen(process.env.PORT, function () {
  _00a‍.g.console.log("Your app is listening on port " + listener.address().port)
})